...
--
-- requires-table: note_videos
--
-- If note_videos does not exist (fresh database), the migration runner skips
-- the SQL body and records this version as applied automatically.
